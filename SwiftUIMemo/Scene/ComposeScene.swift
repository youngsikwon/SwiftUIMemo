...
struct ComposeScene: View {
    ...
    var memo: Memo? = nil // 메모 전달 받으면 편집 -> 쓰기로 변경
    ...
    var body: some View {
        NavigationView {
            VStack {
                ...
                .navigationBarItems(leading: DismissButton(show:
                    $showComposer), trailing: SaveButton(show:
                    $showComposer, content: $content, memo: memo))
        }
        .onAppear {
